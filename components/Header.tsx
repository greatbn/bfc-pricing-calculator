    ...
    <header className="bg-white shadow-sm sticky top-0 z-10">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <button onClick={() => onNavigate('calculator')} className="flex items-center space-x-4 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-lg p-1 cta-bfc-pc-logobizflycloud">
          ...
          <div className="flex items-center space-x-4">
            <button
              ...
              className={`hidden md:flex items-center px-3 py-2 text-sm font-semibold rounded-md transition-colors ${currentPage === 'aiEstimate' ? 'bg-purple-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'} cta-bfc-pc-aiestimategenerator`}
